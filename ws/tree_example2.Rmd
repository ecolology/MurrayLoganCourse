...
site  angaus  seg_sum_t seg_t_seas seg_low_flow ... 
----- ------- ------- -------- ---------- -----
1     0       16.0       -0.10  1.036     ...
2     1       18.7        1.51  1.003     ...
3     0       18.3        0.37  1.001     ...
...
**seg_sum_t**    Summer air temperature (degrees celcius) at the river segment
               scale
**seg_t_seas**   Winter temperature normalised to January temperature at the river
               segment scale
**seg_low_flow** Forth root transformed low flow rate at the river segment scale
...
scatterplotMatrix(~angaus+seg_sum_t+seg_t_seas+seg_low_flow+DSDist+DSMaxSlope+DSDam+
